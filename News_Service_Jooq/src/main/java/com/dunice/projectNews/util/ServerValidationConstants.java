package com.dunice.projectNews.util;
...
public interface ServerValidationConstants {
    ...
    String USER_PASSWORD_NOT_VALID = "author password should be more than 6 symbols";

    String USER_AVATAR_NOT_NULL = "author avatar mustn't be null";

    String USER_AVATAR_NOT_VALID = "author avatar should be between 3 and 130";
    ...
    String USER_EMAIL_NOT_VALID = "author email must be a well-formed email address";
    ...
    String USER_ROLE_NOT_VALID = "author role should be between 3 and 25";

    String USER_PASSWORD_NULL = "author password must be null";

    String USER_EMAIL_NOT_NULL = "author email mustn't be null";
    ...
    String NO_RIGHT_TO_CHANGE_NEWS = "The current author does not have the right to change the news";
}
