...
public enum ServerErrorCodes {
    ...
    UNAUTHORISED(7, ServerValidationConstants.UNAUTHORISED),
    ...
    PASSWORD_NOT_NULL(26, ServerValidationConstants.USER_PASSWORD_NULL),
    ...
    REQUIRED_INT_PARAM_PER_PAGE_IS_NOT_PRESENT(41, ServerValidationConstants.REQUIRED_INT_PARAM_PER_PAGE_IS_NOT_PRESENT),
    ...
    static {
        for (ServerErrorCodes c : ServerErrorCodes.values()) {
    ...
    ServerErrorCodes(int statusCode, String serverValidationConstants) {
        this.statusCode = statusCode;
        this.message = serverValidationConstants;
    }
